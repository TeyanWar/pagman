...
<head>
  ...
  <meta name="keywords" content="materialize, adminMaterialize template, dashboard template, flat adminMaterialize template, responsive adminMaterialize template,">
  <title>Login Page | Inicio Sesion Pagman</title>
  ...
  <link href="<?php echo addLib('templates/adminMaterialize/css/layouts/page-center.css')?>" type="text/css" rel="stylesheet" media="screen,projection">
