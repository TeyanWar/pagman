            ...
            <div class="row">
                <?php if(isset($parametros[1])){ ?>
                 ...
                 <?php }else{ ?>
                    ...
                    <div class="col s4">
                        <label>(*) Equipo</label>
                        <select class="select2" id="selectEqui" name="ot_equipo" data-url="<?php echo crearUrl('Ot', 'ot', 'selectComp', array('noVista' => 'noVista')) ?>">
                            <option value="" disabled selected>Seleccione</option>
                        </select>
                    </div>
...
<!--                <div class="col s4">
            ...
            <div class="row">                
                ...
                <div class="col s4">
                    ...
                    <select name="ot_prioridad" class="browser-default select2">
                        <option value="" disabled selected>Seleccione</option>
            ...
            <div class="row">
                ...
                <div class="input-field col s3">
                    ...
                    <input placeholder="Buscar Insumos" id="insum" name="insumo" type="text" data-url="<?php  echo crearUrl("Ot", "ot", "listarInsumos", array('noVista'=>"noVista"))?>" >
                ...
                <div class="input-field col s3">
                    <i class="mdi-action-search prefix"></i>
                    <input placeholder="Buscar Herramientas" id="herrm" name="herrami" type="text" data-url="<?php  echo crearUrl("Ot", "ot", "listarherramientas", array('noVista'=>"noVista"))?>" >
