        ...
        <form class="col s12" id="crearSolicitud" method="POST" data-redirect="<?php echo crearUrl("Ot", "solicitudes", "listar") ?>" data-url="<?php echo crearUrl("Ot", "solicitudes", "postCrear", array('noVista' => 'noVista')) ?>">
            <div class="row">
                <div class="col s12 m4 l4">                
                    <label>(*) Centro</label>
                    <select id="selectCen" name="centro"  data-url="<?php echo crearUrl('Ot', 'solicitudes', 'selectCen', array('noVista' => 'noVista')) ?>">
                ...
                <div class="col s12 m4 l4">
                    <label>(*) Equipo</label>
                    <select id="selectEqui" name="equipo" >
                        <option value="" disabled selected>Seleccione</option>
                    </select>
                </div>
                ...
                <div class="col s12 m4 l4">
                    ...
                    <select name="tipo_falla" >
                        ...
                        <?php foreach ($tipoFallas as $tipoFalla) { ?>
                            <option value="<?php echo $tipoFalla['tfa_id'] ?>"><?php echo $tipoFalla['tfa_descripcion'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
