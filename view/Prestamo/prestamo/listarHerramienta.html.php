    ...
    <tbody>
        ...
        foreach ($listarHerramienta as $herramienta) {
            ...
            <tr>
                ...
                <td><input type="text" id="detph_cant_entrega-<?php echo trim($herramienta['her_id']) ?>" name="herramientas[<?php echo $herramienta['her_id'] ?>][Cant. entregada]" placeholder="Digite la cantidad enytregada"></td>
