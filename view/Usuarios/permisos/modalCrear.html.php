<div class="col s12 m12 l6">
    <form action = "<?php echo crearUrl("Permisos", "permisos", "postCrear") ?>" name = "formRol" method = "POST">
        <div>
            ...
            ROL ACTUAL <input type="text" name="roles" value="<?php echo $rol['rol_id']; ?>" readonly> 
                <?php
            }
            ?>
        </div>
                ...
                <div class = "col s12 m4 l4" id = "flight-card">
                    ...
                    <div class = "input-field col s12">
                        <select multiple name = "funcionesModulos[]">
                            <option value = "" disabled selected>Selecciona las funciones</option>
                            <?php
                            foreach ($buscarCostos as $costos) {
                                ?>
                                <option value="<?php echo $costos['func_id']; ?>" name=""><?php echo $costos['func_nombre']; ?></option><?php
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="input-field col s12">
                        <select multiple name="funcionesModulos[]">
                            ...
                            foreach ($buscarEquipos as $equipos) {
                                ?>
                                <option value="<?php echo $equipos['func_id']; ?>" name=""><?php echo $equipos['func_nombre']; ?></option><?php
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="input-field col s12">
                        <select multiple name="funcionesModulos[]">
                            ...
                            foreach ($buscarHerramientas as $herramientas) {
                                ?>
                                <option value="<?php echo $herramientas['func_id']; ?>" name=""><?php echo $herramientas['func_nombre']; ?></option><?php
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarInsumos as $insumos) {
                            ?>
                            <option value="<?php echo $insumos['func_id']; ?>" name=""><?php echo $insumos['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarMediciones as $mediciones) {
                            ?>
                            <option value="<?php echo $mediciones['func_id']; ?>" name=""><?php echo $mediciones['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>                    
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarMedidores as $medidores) {
                            ?>
                            <option value="<?php echo $medidores['func_id']; ?>"><?php echo $medidores['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
        ...
        <div class="row" style="margin-left: 0px;">
            ...
            <div class="col s12 m8 l4" id="flight-card">
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        <option value="0" disabled selected>Selecciona las funciones</option>
                        <?php
                        foreach ($buscarOT as $ot) {
                            ?>
                            <option value="<?php echo $ot['func_id']; ?>" name=""><?php echo $ot['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($funcionesBuscar as $permisos) {
                            ?>
                            <option value="<?php echo $permisos['id_permiso']; ?>" name=""><?php echo $permisos['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarPermisos as $permi) {
                            ?>
                            <option value="<?php echo $permi['func_id']; ?>" name=""><?php echo $permi['func_nombre'] ?></option>
                            <?php
                        }
                        ?>
                    </select>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarProgramacion as $programacion) {
                            ?>
                            <option value="<?php echo $programacion['func_id']; ?>" name=""><?php echo $programacion['func_nombre']; ?></option>
                            ?></option><?php }
                        ?>                
                    </select>
                </div>                    
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarRoles as $roles) {
                            ?>
                            <option value="<?php echo $roles['func_id']; ?>" name=""><?php echo $roles['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="input-field col s12">
                    <select multiple name="funcionesModulos[]">
                        ...
                        foreach ($buscarUsuarios as $usuarios) {
                            ?>
                            <option value="<?php echo $usuarios['func_id']; ?>" name=""><?php echo $usuarios['func_nombre']; ?></option><?php
                        }
                        ?>
                    </select>
                </div>
