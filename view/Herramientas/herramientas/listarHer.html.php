<div class="center col s12">
        ...
        <tbody>
            ...
            foreach ($listarHer as $herramienta) {
                ...
                <tr>
                    ...
                    <td><?php echo $herramienta['her_imagen'] ?></td>
                    ...
                    <td><a class="modal-eliminar btn-floating waves-effect waves-light red darken-4" data-her_id="<?php echo $herramienta['her_id'] ?>" data-url="<?php echo crearUrl('herramientas', 'herramientas', 'postEliminar', array('noVista' => 'noVista', 'her_id' => $herramienta['her_id'])) ?>"><i class="mdi-action-delete small"></i></a></td>
    ...
    <div id="modalEditar" class="modal" style="display: none; opacity: 1; top: 0px;">
        ...
        <div class="modal-footer">
            <a href="#" class="waves-effect waves-green btn-flat modal-close">Cerrar</a>
        </div>
    </div>
