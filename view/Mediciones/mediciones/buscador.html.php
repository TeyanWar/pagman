    ...
    <div class="container">
        ...
        <form class="col s12">
            <div class="input-field">
                ...
                <input type="text" class="active" id="buscarMed" name='buscarMed' class="header-search-input z-depth-2" data-url="<?php echo crearUrl("Mediciones", "mediciones", "buscador", array('noVista' => "noVista")) ?>" />
                <label for="buscarMed" class="active">Digite el nombre de un equipo</label>
            </div>
        </form>

        <div id="busquedaMediciones">
